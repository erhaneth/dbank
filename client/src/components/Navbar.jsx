...
function NavBar() {
    ...
    return (
     <nav className="w-full flex md:justify-center bg-white">
        ...
        {toggle && (
          <ul
            className="z-10 fixed top-0 -right-2 p-3 w-[70vw] h-screen bg-gray-200 shadow-lg md:hidden list-none flex flex-col justify-start items-end blue-glassmorphism"
          >
            <li className="text-xl w-full my-2"><AiOutlineClose onClick={() => setToggle(false)} /></li>
            {["Transactions", "Wallets"].map(
