  ...
  useEffect(() => {
    const fetchGifs = async () => {
      ...
      //const response = await fetch(`https://api.giphy.com/v1/gifs/search?api_key=${APIKEY}&q=${keyword.split(" ").join("")}&limit=1`);
        // const response = await fetch(`https://api.giphy.com/v1/gifs/search?api_key=w784562ksajhasjdhjkdsfncaskdjh=${keyword.split(" ").join("")}&limit=1&offset=0&rating=g&lang=en`);
